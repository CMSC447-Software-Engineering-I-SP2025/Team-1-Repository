...
const AddFriendPage = ({ currentUser, setCurrentPage }) => {
  // Assuming userId is passed as a prop or from context
  ...
  return (
    <div className="login-container">
      <form className="login-form" onSubmit={sendFriendRequest}>
        <h2>Send friend request from: {currentUser.UserName} to:</h2>
